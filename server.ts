...
async function main() {
  await client.send({
    ...
    body: {
      ...
      suggestions: [
        { type: 'REPLY', text: '15/10 à 08:30', postbackData: 'resched_20261015T0830' },
        { type: 'REPLY', text: '15/10 à 11:30', postbackData: 'resched_20261015T1130' },
        { type: 'REPLY', text: '16/10 à 09:00', postbackData: 'resched_20261016T0900' },
        { type: 'REPLY', text: '18/10 à 14:30', postbackData: 'resched_20261018T1430' }
      ]
    }
  });
